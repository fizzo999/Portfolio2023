  ...
  return (
    <Fragment>
      ...
      centered backdropClassName="projectModalBackdrop">
        ...
        <Modal.Body>
          <iframe width="100%" height="100%" src="https://www.youtube.com/embed/u6FRsxH8nK4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen title={"video animation of favorite movies list app website"}></iframe>
        </Modal.Body>
        <Modal.Footer>
